...
sb_locs <- read_csv("/Users/zhusiyi/Downloads/starbucks-locations.csv")

sb_nutr <- read_csv("/Users/zhusiyi/Downloads/starbucks-menu-nutrition.csv")

usa_pop <- read_csv("/Users/zhusiyi/Downloads/us_state_pop.csv")

usa_states<-read_csv("/Users/zhusiyi/Downloads/states.csv")
